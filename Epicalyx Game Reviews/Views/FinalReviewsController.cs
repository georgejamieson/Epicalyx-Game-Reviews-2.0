...
namespace Epicalyx_Game_Reviews.Views
{
    public class FinalReviewsController : Controller
    {
        ...
        public FinalReviewsController(Epicalyx_Game_ReviewsContextDb context)
        {
            _context = context;
        }
        ...
        {
            var epicalyx_Game_ReviewsContextDb = _context.FinalReview.Include(f => f.Game).Include(f => f.User);
